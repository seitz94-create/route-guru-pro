      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center text-white">
          ...
          <div className="flex gap-4 justify-center">
            ...
            behavior: 'smooth'
          })} className="border-white bg-slate-50 text-[#3fb1df]">
              {t('hero.learn')}
            </Button>
          </div>
        </div>
      ...
      <section id="features" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => <Card key={index} className="p-6 hover:shadow-elevated transition-shadow bg-card">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="overflow-hidden group cursor-pointer">
              <div className="relative h-64">
                <img src={heroCyclist} alt="Road Cycling" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
            ...
            <Card className="overflow-hidden group cursor-pointer">
              <div className="relative h-64">
                <img src={gravelCyclist} alt="Gravel Cycling" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
            ...
            <Card className="overflow-hidden group cursor-pointer">
              <div className="relative h-64">
                <img src={mtbCyclist} alt="Mountain Biking" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
